package com.pragma.user.domain.helper.constants;
...
public class ExceptionConstants {
    ...
    public static final String DOCUMENT_ID_IS_NOT_A_NUMBER_MESSAGE = "The document id is not a number";
    public static final String LEGAL_AGE_MESSAGE = "The user must be of legal age";
}
